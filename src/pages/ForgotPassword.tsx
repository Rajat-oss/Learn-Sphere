          ...
          {sent ? (
            ...
            <>
              <div className="text-center space-y-2">
                <h1 className="font-display text-4xl font-black text-white">Reset Password</h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <Button
                  type="submit"
                  className="w-full h-14 bg-gradient-to-r from-[#FF7A2B] to-[#FF9E4A] hover:from-[#FF9E4A] hover:to-[#FF7A2B] text-white font-bold rounded-xl hover:-translate-y-1 hover:shadow-lg hover:shadow-orange-500/40 transition-all duration-300"
                >
                  Send Reset Link
                </Button>
