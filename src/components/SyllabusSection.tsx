...
const SyllabusSection = () => {
  ...
  return (
    <section 
      id="syllabus" 
      ref={ref as any}
      className="py-24 lg:py-32 px-4 bg-white scroll-mt-20"
    >
      <div className="container mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <h2 
              className={`font-display text-4xl sm:text-5xl lg:text-6xl font-black leading-[1.1] transition-all duration-600 ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
              }`}
            ...
            <p 
              className={`text-lg text-[#667085] leading-relaxed max-w-xl transition-all duration-600 ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
              }`}
            ...
            >
              {[
                ...
                <div key={item.num} className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-[#0B1A2A] text-lg">{item.title}</h3>
          ...
          >
            {/* Back Card - Navy */}
            <div className="absolute top-0 right-0 w-[320px] h-[420px] bg-[#0B1A2A] rounded-3xl shadow-2xl transform rotate-6 translate-x-8 translate-y-8" />
            
            {/* Middle Card - White */}
            <div className="absolute top-0 right-0 w-[320px] h-[420px] bg-white rounded-3xl shadow-xl transform rotate-3 translate-x-4 translate-y-4 border-2 border-gray-100" />
            
            {/* Front Card - Orange */}
            <div className="absolute top-0 right-0 w-[320px] h-[420px] bg-gradient-orange rounded-3xl shadow-glow-orange transform hover:scale-105 transition-transform duration-300">
              <div className="p-8 h-full flex flex-col justify-between text-white">
                <div>
                  ...
                  <p className="text-white/80 text-sm">Full access to all courses</p>
                </div>
                <div>
                  <div className="mb-6">
